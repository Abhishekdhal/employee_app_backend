...
// 2. GET ALL LEAVES (Employer Only) - ONLY PENDING
...
// 🆕 3. GET MY LEAVE REQUESTS (Employee - All Statuses)
router.get('/my-requests', verifyToken, async (req, res) => {
  try {
    // Fetch all leaves for the logged-in user (pending, approved, rejected)
...
// 4. APPROVE/REJECT LEAVE (Employer Only)
